...
def fmb_classes():
    """Cityscapes class names for external use."""
    return [
        'Background', 'Road', 'Sidewalk', 'Building', 'TrafficLight', 'TrafficSign',
        'Tree', 'Sky', 'Human', 'Car', 'Truck', 'Bus', 'Motorcycle', 'Bike', 'Pole'
    ]
...
def whu_classes():
    """Cityscapes class names for external use."""
    return [
        'Background', 'Farmland', 'City', 'Village', 
...
def fmb_palette():
    """Cityscapes palette for external use."""
    return [[0, 0, 0], [1, 1, 1], [2, 2, 2], [3, 3, 3], [4, 4, 4], [5, 5, 5], 
            [6, 6, 6], [7, 7, 7], [8, 8, 8],
...
def whu_palette():
    """Cityscapes palette for external use."""
    return [[0 ,0 ,0], [10, 10, 10], [20, 20, 20], [30, 30, 30], 
