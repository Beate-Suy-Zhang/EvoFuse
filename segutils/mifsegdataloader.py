...
class SegDataset(Dataset):
    def __init__(
        ...
        self.stage = stage
        self.img_dir = os.path.join(root_dir, split, 'images'+name_str)
        ...
        # print('FMB12 dataset path:', os.path.join(root_dir, split))
        # print('FMB12 dataset size:', len(self.name_list))
    ...
    def __getitem__(self, idx):
        ...
        img_name = os.path.join(self.img_dir, _img_name[0:-4]+'.png')
        image = np.asarray(imageio.imread(img_name))

        if self.stage == "train":

            label_dir = os.path.join(self.label_dir, _img_name[0:-4]+'.png')
...
class SegClsDataset(SegDataset):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
...
class SegSegDataset(SegDataset):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
        ...
        super().__init__(root_dir, name_list_dir, split, stage, name_str)
