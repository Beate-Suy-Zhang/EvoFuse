...
from detutils import TryExcept
from detutils.dataloaders import exif_transpose, letterbox
from detutils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_notebook, make_divisible, non_max_suppression, scale_boxes,
                           xywh2xyxy, xyxy2xywh, yaml_load)
from detutils.plots import Annotator, colors, save_one_box
from detutils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if pt:  # PyTorch
            ...
            from detutils.triton import TritonRemoteModel
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from detutils.downloads import is_url
