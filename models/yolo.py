...
from detutils.general import LOGGER, check_version, check_yaml, make_divisible, print_args
from detutils.plots import feature_visualization
from detutils.torch_utils import (fuse_conv_and_bn, initialize_weights, model_info, profile, scale_img, select_device,
                               time_sync)
from detutils.tal.anchor_generator import make_anchors, dist2bbox
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolo.yaml', ch=3, nc=None, anchors=None, verbose=True):  # model, input channels, number of classes
        super().__init__()
