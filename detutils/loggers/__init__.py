...
from detutils.general import LOGGER, colorstr, cv2
from detutils.loggers.clearml.clearml_utils import ClearmlLogger
from detutils.loggers.wandb.wandb_utils import WandbLogger
from detutils.plots import plot_images, plot_labels, plot_results
from detutils.torch_utils import de_parallel
...
try:
    if RANK not in [0, -1]:
        ...
        from detutils.loggers.comet import CometLogger
